...
\begin{figure}[h!] \centering \caption{Modified Shepp-Logan phantom
	reconstructed using a circulant matrix with RPMS restriction.}
	\includegraphics[width=0.6\textwidth, trim= 0 40 0 40,
	clip=true]{figs/rpms.pdf} \label{fig:shepplogan} \end{figure}


\begin{table}[h] \begin{tabular}{lll|lllll} \textbf{Matrix Type}       &
...
\begin{table}[h] \begin{tabular}{l|lllllll} \textbf{Matrix Type} & Gaussian &
